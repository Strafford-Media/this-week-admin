INSERT INTO listing (business_name, slug, primary_phone, primary_email, primary_address, island, description, primary_web_url, tier, slogan)
VALUES
    ('Aloha Adventures','aloha-adventures', '808-555-1234', 'info@alohaadventures.com', '1234 Beach Blvd, Honolulu, HI', 'oahu',
    ...
    ('Hula Hike Hawaii','hula-hike-hawaii', '808-555-5678', 'info@hulahikehawaii.com', '5678 Mountain Rd, Waikiki, HI', 'oahu',
    ...
    ('Tropical Treasures Tours','tropical-treasures-tours
', '808-555-1111', 'info@tropicaltreasurestours.com', '1111 Paradise Lane, Honolulu, HI', 'oahu',
    ...
    ('Maui Luau Magic','maui-luau-magic
', '808-555-2222', 'info@mauiluaumagic.com', '2222 Sunset Beach Rd, Lahaina, HI', 'maui',
    ...
    ('Volcano Ventures','volcano-ventures', '808-555-3333', 'info@volcanoventures.com', '3333 Lava Lane, Hilo, HI', 'oahu',
    ...
    ('Island Breeze Surf School','island-breeze-surf-school', '808-555-4444', 'info@islandbreezesurfschool.com', '4444 Surfside Dr, North Shore, HI', 'oahu',
    ...
    ('Hawaiian Helicopter Tours','hawaiian-helicopter-tours', '808-555-5555', 'info@hawaiianhelicoptertours.com', '5555 Skyview Ave, Kauai, HI', 'hawaii',
    ...
    ('Paddle Paradise','paddle-paradise','808-555-6666', 'info@paddleparadise.com', '6666 Bayfront Dr, Kailua-Kona, HI', 'oahu',
    ...
    ('Aloha Art Adventures','aloha-art-adventures', '808-555-7777', 'info@alohaartadventures.com', '7777 Gallery Lane, Waikiki, HI', 'oahu',
    ...
    ('Jungle Zip Line Tours','jungle-zip-line-tours', '808-555-8888', 'info@jungleziplinetours.com', '8888 Rainforest Rd, Hana, HI', 'oahu',
    ...
    ('Sunset Sailing Adventures','sunset-sailing-adventures', '808-555-9999', 'info@sunsetsailingadventures.com', '9999 Harbor View Dr, Honolulu, HI', 'oahu',
    ...
    ('Tiki Tropicana Luau','tiki-tropicana-luau', '808-555-1230', 'info@tikitropicanaluau.com', '1230 Tiki Terrace, Waikiki, HI', 'oahu',
    ...
    ('Paradise Paddle Yoga','paradise-paddle-yoga', '808-555-1231', 'info@paradisepaddleyoga.com', '1231 Yoga Cove, Honolulu, HI', 'oahu',
    ...
    ('Hawaiian Horseback Rides','hawaiian-horseback-rides
', '808-555-1232', 'info@hawaiianhorsebackrides.com', '1232 Ranch Road, Waimea, HI', 'oahu',
    ...
    ('Aloha Aquarium Adventure','aloha-aquarium-adventure', '808-555-1233', 'info@alohaaquariumadventure.com', '1233 Coral Cove, Hilo, HI', 'hawaii',
    ...
    ('Tropical Tunes Ukulele Lessons','tropical-tunes-ukulele-lessons', '808-555-1235', 'info@tropicaltunesukulelelessons.com', '1235 Music Ave, Lahaina, HI', 'maui',
    ...
    ('Sunrise Surf Safaris','sunrise-surf-safaris', '808-555-1236', 'info@sunrisesurfsafaris.com', '1236 Surfside Blvd, North Shore, HI', 'oahu',
    ...
    ('Kauai Hiking Haven','kauai-hiking-haven', '808-555-1237', 'info@hawaiihikinghaven.com', '1237 Mountain Path, Waikiki, HI', 'kauai',
    ...
    ('Pineapple Paradise Snorkeling','pineapple-paradise-snorkeling', '808-555-1238', 'info@pineappleparadisesnorkeling.com', '1238 Beach Cove, Wailea, HI', 'kauai',
