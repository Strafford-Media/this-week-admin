...
import { useQueryToaster } from './hooks'
...
export const App = () => {
  ...
  return (
    <>
      <main className={`flex h-content max-w-screen flex-col pb-16 sm:pb-0 sm:pt-16`}>
        <Outlet />
      </main>
      <nav className="fixed bottom-0 flex h-16 w-full max-w-screen items-stretch justify-evenly bg-primary-50 transition-all duration-300 sm:top-0 sm:justify-end z-40 [view-transition-name:header-nav]">
