...
export type Listing = {
  ...
  is_island_original: Scalars['Boolean'];
...
export type Listing_Bool_Exp = {
  ...
  is_island_original?: InputMaybe<Boolean_Comparison_Exp>;
  island?: InputMaybe<String_Comparison_Exp>;
...
export type Listing_Insert_Input = {
  ...
  id?: InputMaybe<Scalars['Int']>;
  images?: InputMaybe<Scalars['jsonb']>;
  is_island_original?: InputMaybe<Scalars['Boolean']>;
  island?: InputMaybe<Scalars['String']>;
...
export type Listing_Order_By = {
  ...
  is_island_original?: InputMaybe<Order_By>;
  island?: InputMaybe<Order_By>;
...
export enum Listing_Select_Column {
  ...
  Images = 'images',
  /** column name */
  IsIslandOriginal = 'is_island_original',
  /** column name */
  Island = 'island',
  /** column name */
  LatLng = 'lat_lng',
...
export type AllListingsSubscription = { __typename?: 'subscription_root', listing: Array<{ __typename?: 'listing', business_name: string, island?: string | null, created_at: any, updated_at: any, id: number, tier: string, live: boolean, this_week_recommended: boolean, is_island_original: boolean, promoted: boolean }> };
...
export type FuzzySearchListingsQueryVariables = Exact<{
  ...
  limit: Scalars['Int'];
  orderBy?: InputMaybe<Array<Fuzzy_Listing_Order_By> | Fuzzy_Listing_Order_By>;
}>;
...
export type BreadcrumbsQueryVariables = Exact<{ [key: string]: never; }>;
