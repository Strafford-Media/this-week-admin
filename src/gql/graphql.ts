...
export type AllListingsSubscription = { __typename?: 'subscription_root', listing: Array<{ __typename?: 'listing', business_name: string, island?: string | null, created_at: any, updated_at: any, id: number, tier: string, live: boolean, this_week_recommended: boolean, promoted: boolean }> };
